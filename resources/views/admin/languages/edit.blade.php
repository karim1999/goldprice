...
@section('content')
    <section class="viewText">
        ...
        <div class="row text-right"  style="background: ">
        	<form method="POST" action="{{route('languages.update' ,$language['id'] )}}"  class="row col-12">
        		@csrf
        		{{ method_field('PATCH') }}
	        	<div class="col-12" style="padding: 50px 2% 50px;background: #fff">
	        		 ...
	        		 <div class="col-12 col-md-7 row" style="padding: 6px;">
	                      ...
	                      <div class="col-sm-9">
	                          <input type="text" name="lang_name" class="form-control" value="{{$language['lang_name']}}" autofocus="" required="">
	                      </div>
	                 </div>
	                 ...
	                 <div class="col-12 col-md-7 row" style="padding: 6px;">
	                      ...
	                      <div class="col-sm-9">
	                          <input type="text" name="shortcut_name" class="form-control" value="{{$language['shortcut_name']}}" max="3" required>
	                      </div>
	                 </div>
